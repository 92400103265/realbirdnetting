...
<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
  ...
  >
    ...
    {/* Put your Desktop Navigation and Mobile Controls here */}
  </div>
</div>
...
<div className="hidden sm:flex items-center space-x-1.5 xl:space-x-2.5">
  ...
  <a
    ...
    className="group flex items-center space-x-1.5
      ...
      text-white px-2.5 py-2 xl:px-3.5 xl:py-2.5
      rounded-xl text-xs xl:text-sm font-bold
...
<div className="lg:hidden flex items-center space-x-2">
  ...
  <button
    ...
    className="w-11 h-11 flex items-center justify-center rounded-xl
      transition-colors border border-slate-200 bg-slate-50
  ...
  <a
    ...
    className="w-11 h-11 flex items-center justify-center rounded-xl
      ...
      hover:opacity-95 shadow-md transition-all active:scale-95"
          ...
          >
            <div className="bg-white/95 backdrop-blur-xl border border-slate-200 shadow-2xl rounded-2xl overflow-hidden p-5 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3 pt-3 border-t border-slate-100">
                ...
                <a
                  href="tel:+919354254539"
                  className="flex items-center justify-center gap-2 bg-gradient-to-r from-orange-500 to-orange-600 text-white py-3.5 rounded-xl text-sm font-bold shadow-md hover:opacity-90 transition-all active:scale-95"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2 bg-gradient-to-r from-emerald-500 to-teal-600 text-white py-3.5 rounded-xl text-sm font-bold shadow-md hover:opacity-90 transition-all active:scale-95"
                >
                  <svg
                    ...
                    aria-hidden="true"
                  >
                    <path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946C.06 5.348 5.397.01 12.008.01c3.202.001 6.212 1.248 8.477 3.517 2.266 2.268 3.507 5.28 3.505 8.484-.004 6.657-5.34 11.997-11.953 11.997-2.005-.001-3.973-.502-5.724-1.455L0 24z" />
                  </svg>
